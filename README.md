...
| Pipeline phases and gate behavior | [docs/how-it-works.md](docs/how-it-works.md) |
...
| Incremental file state | [docs/how-it-works.md](docs/how-it-works.md), [docs/cli.md](docs/cli.md) |
